...
| ❌ | **#83 Find in Update** | Expected valid=False, got True \| Found issue: Avoid GameObject.Find() in Update loops. |
...
| ❌ | **#85 GetComponent Update** | Expected valid=False, got True \| Found issue: Avoid GameObject.Find() in Update loops. |
...
| ❌ | **#86 Vector Math** | Expected valid=True, got False |
