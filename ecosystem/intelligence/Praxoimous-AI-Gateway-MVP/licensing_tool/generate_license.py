...
# Import the load_private_key and create_signed_license_payload from your core module
from core.license_generator import load_private_key, create_signed_license_payload
