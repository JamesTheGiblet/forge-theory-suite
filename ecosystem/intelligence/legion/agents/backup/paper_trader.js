  ...
  for (const file of files) {
    try {
      ...
      if (!pos.inTrade && entryMet) {
        ...
        // console.log(`[PAPER] ${strategy.scp_id} entered at $${currentPrice}`);
        ...
        // console.log(`[PAPER] ${strategy.scp_id} exited | Paper PnL: ${(pnlPercent*100).toFixed(2)}% | Real PnL: ${(realPnl*100).toFixed(2)}%`);
...
function startPaperTrader() {
  loadPaperState();
  // console.log('[PAPER] Ready – simulating paper trades with real PnL from MK1');
