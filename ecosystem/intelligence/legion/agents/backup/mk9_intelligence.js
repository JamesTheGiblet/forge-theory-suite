...
class MK9Intelligence {
  ...
  async initialize() {
    // console.log('[MK9] Initializing intelligence layer...');
  ...
  async analyzeMarket() {
    ...
    // console.log(`[MK9] Analysis: ${analysis.direction} | Current: $${currentPrice} | Predicted: $${prediction.toFixed(2)} | Confidence: ${analysis.confidence.toFixed(1)}%`);
  ...
  async start() {
    ...
    // console.log('[MK9] Starting intelligence loop...');
