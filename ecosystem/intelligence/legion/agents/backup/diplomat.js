...
function startDiplomat() {
  // console.log('[DIPLOMAT] Ready – Telegram alerts active');
  ...
  registerHandler('KETER_AUTHORISED', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent KETER_AUTHORISED for ${strategyId}`);
  });
  ...
  registerHandler('CONTAINMENT_BREACH', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent CONTAINMENT_BREACH for ${strategy.scp_id}`);
  });
  ...
  registerHandler('APOLLYON_BREACH', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent APOLLYON_BREACH for ${strategy.scp_id}`);
  });
  ...
  registerHandler('LINEAGE_THRASHING', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent LINEAGE_THRASHING for ${parentId}`);
  });
  ...
  registerHandler('LINEAGE_EVOLVING', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent LINEAGE_EVOLVING for ${parentId}`);
  });
  ...
  registerHandler('REGIME_CHANGE', (msg) => {
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent REGIME_CHANGE: ${oldRegime} → ${newRegime}`);
  });
  ...
  registerHandler('TOURNAMENT_LEADERBOARD', (msg) => {
    ...
    if (!leaderboard || leaderboard.length === 0) {
      // console.log('[DIPLOMAT] No leaderboard to send');
      return;
    }
    ...
    queueMessage(text);
    // console.log(`[DIPLOMAT] Sent TOURNAMENT_LEADERBOARD with ${leaderboard.length} entries`);
  });
}
...
registerHandler('PORTFOLIO_UPDATE', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent PORTFOLIO_UPDATE alert');
});
...
registerHandler('SENTIMENT_ALERT', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent SENTIMENT_ALERT');
});
...
registerHandler('ARBITRAGE_OPPORTUNITY', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent ARBITRAGE_OPPORTUNITY alert');
});
...
registerHandler('WHALE_TRANSACTION', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent WHALE_TRANSACTION alert');
});
...
registerHandler('EXCHANGE_FLOW', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent EXCHANGE_FLOW alert');
});
...
registerHandler('WHALE_DETECTION', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent WHALE_DETECTION alert');
});
...
registerHandler('VIX_SUMMARY', (msg) => {
  ...
  queueMessage(text);
  // console.log('[DIPLOMAT] Sent VIX_SUMMARY alert');
});
...
registerHandler('NARRATIVE', (msg) => {
  ...
  // console.log('[DIPLOMAT] Narrated to Telegram');
});
...
registerHandler('VOICE_COMMAND', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent voice transcript');
});
...
registerHandler('SELF_IMPROVEMENT', (msg) => {
  ...
  // console.log('[DIPLOMAT] Sent self-improvement analysis');
});
...
registerHandler('IMPROVEMENT_APPLIED', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent IMPROVEMENT_APPLIED alert');
});
...
registerHandler('CROSS_ARBITRAGE', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent CROSS_ARBITRAGE alert');
});
...
registerHandler('WHALE_ACTIVITY', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent WHALE_ACTIVITY alert');
});
...
registerHandler('SOCIAL_SENTIMENT', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent SOCIAL_SENTIMENT alert');
});
...
registerHandler('DEX_EXECUTION', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent DEX_EXECUTION alert');
});
...
registerHandler('MEV_ALERT', (msg) => {
  ...
  queueMessage(text, 'Markdown');
  // console.log('[DIPLOMAT] Sent MEV_ALERT');
});
